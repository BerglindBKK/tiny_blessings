    ...
    <section id="foundation" className="bg-white py-16 md:py-24">
      <div className="px-5 max-w-6xl mx-auto lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          {/* RIGHT: NARRATIVE IMAGE (growing.png) */}
          <div className="relative aspect-square md:aspect-video lg:aspect-[4/3] rounded-3xl overflow-hidden shadow-xl">
            <Image
        ...
        <div className="mt-20 md:mt-28 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* NUTRITION */}
          <div className="bg-soft border border-border rounded-2xl p-8 transition-all duration-300 hover:border-coral hover:-translate-y-1 group">
            <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-navy shadow-sm group-hover:bg-coral group-hover:text-white transition-colors">
              <span className="text-xl">🥗</span>
            </div>
            <h3 className="mt-6 text-[18px] md:text-[20px] font-bold text-navy">
              Nutrition
            </h3>
