    ...
    <header className="w-full bg-white border-b border-border sticky top-0 z-50">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-5 py-4 lg:px-8">
        ...
        <div className="hidden md:block">
          <button className="bg-coral text-white text-[14px] font-semibold px-6 py-2.5 rounded-full hover:bg-[#d65d41] hover:shadow-lg transition-all active:scale-95">
            Support
          </button>
        </div>
      ...
      {open && (
        <div className="md:hidden px-5 py-6 space-y-6 bg-white border-t border-border animate-in fade-in slide-in-from-top-4 duration-300">
          ...
          <button className="w-full bg-coral text-white text-[15px] font-bold px-4 py-4 rounded-full shadow-md active:scale-[0.98] transition-transform">
            Support a Child
          </button>
        </div>
      )}
