      ...
      <div className="px-5 max-w-6xl mx-auto lg:px-8">
        <div className="max-w-4xl">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <button className="bg-coral text-white px-8 py-4 rounded-full font-bold text-[15px] transition-all hover:bg-opacity-90 hover:scale-[1.02]  transition-transform  flex items-center gap-2">
              <a href="#donate">
                <Image
