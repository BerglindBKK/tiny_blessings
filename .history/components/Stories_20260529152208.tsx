<section id="stories" className="bg-soft py-16 md:py-24">
  <div className="px-5 max-w-6xl mx-auto lg:px-8">
    ...
    <p className="mt-4 text-[15px] md:text-[16px] text-body max-w-3xl">
      Real moments from children and families supported through our education,
      nutrition, and care programs in Makati City.
    </p>
    ...
    <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="bg-white border border-border rounded-2xl overflow-hidden">
        ...
        <div className="p-6">
          ...
          <p className="mt-3 text-body text-[14px] leading-6">
            A child was able to return to formal schooling after receiving
            consistent learning support and mentoring through our program.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white border border-border rounded-2xl overflow-hidden">
        ...
        <div className="p-6">
          ...
          <p className="mt-3 text-body text-[14px] leading-6">
            Through weekly one-on-one reading sessions, a child began building
            confidence and participating more actively in learning activities.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white border border-border rounded-2xl overflow-hidden">
        ...
        <div className="p-6">
          ...
          <p className="mt-3 text-body text-[14px] leading-6">
            Feeding programs help provide consistent meal support for children
      ...
      <div className="bg-white border border-border rounded-2xl overflow-hidden">
        ...
        <div className="p-6">
          ...
          <p className="mt-3 text-body text-[14px] leading-6">
            Children take part in structured activities that support learning,
            play, and emotional well-being in a safe environment.
          </p>
        </div>
      </div>
    </div>
