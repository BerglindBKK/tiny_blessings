      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center lg:items-start">
          ...
          <div className="order-1 lg:order-2 lg:mt-16">
            ...
            <p className="mt-4 text-sm md:text-base text-muted italic lg:hidden">
              Hands in the dirt, hearts at work
            </p>
          </div>

          {/* TEXT */}
          <div className="order-2 lg:order-1 max-w-4xl flex flex-col">
            <h2 className="text-4xl md:text-5xl lg:text-6xl leading-tight font-serif text-navy">
              Our Foundation
            </h2>

            <div className="mt-6 space-y-5 text-base md:text-lg leading-relaxed text-body">
              <p>
