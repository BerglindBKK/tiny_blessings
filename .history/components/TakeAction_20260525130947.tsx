    ...
    <section className="bg-navy py-14">
      ...
      <div className="px-5 mt-10 max-w-6xl mx-auto">
        <div className="border border-white/20 rounded-xl p-5 text-white/90">
          ...
          {/* PAYMENT METHODS */}
          <div className="mt-4 grid grid-cols-2 gap-2 text-[13px] text-white/80">
            <div>GCash</div>
            <div>PayPal</div>
            <div>Venmo</div>
            <div>Zelle</div>
          ...
          <div className="mt-5 text-[12px] text-white/70 leading-5">
            QR codes and full account details are available upon request or
            through direct message on Instagram.
          </div>
        </div>
      </div>
