    ...
    <section id="foundation" className="bg-white py-16 md:py-24">
      <div className="px-5 max-w-6xl mx-auto lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Image: Appears first on mobile (order-1), moves to right on desktop (lg:order-2) */}
          <div className="order-1 lg:order-2 relative aspect-[4/5] sm:aspect-square md:aspect-video lg:aspect-[4/3] rounded-2xl overflow-hidden shadow-sm">
            <Image
          ...
          {/* Text: Appears second on mobile (order-2), moves to left on desktop (lg:order-1) */}
