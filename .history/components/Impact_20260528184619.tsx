      ...
      <div className="px-5 max-w-6xl mx-auto lg:px-8">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-[15px] leading-7 md:text-[16px] md:leading-8 text-body max-w-2xl">
            Every number reflects real children receiving consistent education,
            meals, healthcare support, and safe community-based care through our
            programs in Makati City. These outcomes are made possible through
            local volunteers, partner communities, and ongoing outreach efforts
            that ensure children are not only supported in the moment, but given
            the opportunity to grow, learn, and thrive long-term.
          </p>
        </div>
