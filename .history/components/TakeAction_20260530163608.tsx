    ...
    <section id="donate" className="bg-navy py-24 md:py-32">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-4">
          {/* One-time */}
          <div className="bg-white/10 border border-white/20 text-white rounded-2xl p-6 text-center">
            <div className="font-bold">
              One-time <span className="text-coral">Donation</span>
            </div>
          ...
          {/* Monthly */}
          <div className="bg-white/10 border border-white/20 text-white rounded-2xl p-6 text-center">
            <div className="font-bold">Monthly Support</div>
            <p className="text-sm font-normal mt-2 text-white/70 leading-relaxed">
          ...
          {/* Sponsor */}
          <div className="bg-white/10 border border-white/20 text-white rounded-2xl p-6 text-center">
            <div className="font-bold">Sponsor a Child</div>
            <p className="text-sm font-normal mt-2 text-white/70 leading-relaxed">
          ...
          {/* Volunteer */}
          <div className="bg-white/10 border border-white/20 text-white rounded-2xl p-6 text-center">
            <div className="font-bold">Volunteer / Collaborate</div>
            <p className="text-sm font-normal mt-2 text-white/70 leading-relaxed">
