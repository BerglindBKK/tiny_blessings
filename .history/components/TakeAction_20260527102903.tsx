      ...
      <div className="px-5 max-w-6xl mx-auto">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-xl p-5">
            ...
            <p className="mt-2 text-[13px] text-body leading-5">
              Helps with urgent needs like food, supplies, and medical support.
            </p>
          </div>
        ...
        {/* PAYMENT INFO — FULL TRANSPARENCY */}
        <div className="mt-10 border border-white/20 rounded-xl p-5 text-white/80">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6 text-[13px]">
            {/* GCash */}
            <div>
