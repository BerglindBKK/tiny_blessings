    ...
    <section className="bg-white">
      ...
      <div className="px-5 pt-8 pb-16">
        ...
        <div className="mt-8 flex gap-3 ">
          ...
          >
            <img src="/images/donate_icon.png" alt="icon" className="w-5 h-5" />
          ...
          <button
            ...
            className="bg-coral text-white px-6 py-3 rounded-full hover:shadow-sm transition inline-flex items-center gap-2"
          >
            <img
