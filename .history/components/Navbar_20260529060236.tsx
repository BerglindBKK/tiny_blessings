      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between px-5 py-4 lg:px-8">
        ...
        <div className="hidden md:block">
          <a
            ...
            className="block w-full text-center bg-coral text-white text-[15px] font-bold px-4 py-4 rounded-full shadow-md active:scale-[0.98] transition-transform  items-center gap-2"
          >
            <Image
