      ...
      <div className="px-5 mt-10 max-w-6xl mx-auto">
        <div className="border border-white/20 rounded-xl p-5 text-white/90">
          ...
          <div className="mt-4 space-y-3 text-[13px] text-white/80">
            <div>
              <span className="font-medium text-white">GCash:</span> QR code
              available
            </div>
            ...
            <div>
              <span className="font-medium text-white">Zelle:</span> transfer
              details available
            </div>

            <div>
              <span className="font-medium text-white">PayPal:</span> link
              available upon request
            </div>

            <div>
              <span className="font-medium text-white">Venmo:</span> handle
              available upon request
            </div>
          </div>

          {/* TRUST NOTE */}
          <div className="mt-5 text-[12px] text-white/70 leading-5">
            All payment details and QR codes are available through direct
            message or Instagram.
          </div>
        </div>
      </div>
