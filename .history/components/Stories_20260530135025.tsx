...
<div className="bg-white border border-border rounded-2xl overflow-hidden">
  ...
  <div className="p-6">
    ...
    <p className="mt-3 text-[14px] text-body leading-6">
      After years of hard work and dedication, Mikmik was accepted into Food
      for Hungry Minds, a scholarship school that supports students who
      demonstrate strong academic performance, discipline, and character.
    </p>

    <p className="mt-3 text-[14px] text-body leading-6">
      Despite growing up in difficult circumstances, she maintained excellent
      attendance and consistently performed well in school. Her acceptance
      marks an important milestone in a journey shaped by perseverance,
      community support, and belief in her potential.
    </p>
  </div>
...
<div className="bg-white border border-border rounded-2xl overflow-hidden">
  ...
  <div className="p-6">
    ...
    <p className="mt-3 text-[14px] text-body leading-6">
      Two of our Big Kids earned the opportunity to represent Tiny Blessings
      Foundation at the ISM Charity Bazaar after being recognized for
      outstanding attendance and learning performance.
    </p>

    <p className="mt-3 text-[14px] text-body leading-6">
      Over two days, they managed sales, interacted with customers, and worked
      alongside local partners and volunteers. The experience helped build
      confidence, communication skills, and a broader sense of what may be
