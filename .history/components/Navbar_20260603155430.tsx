      ...
      {open && (
        <div className="md:hidden px-5 py-6 space-y-6 bg-white border-t border-border animate-in fade-in slide-in-from-top-4 duration-300">
          ...
          <a
            href="#donate"
            onClick={() => setOpen(false)}
            className="flex items-center justify-center gap-2 w-full text-center bg-coral text-white text-[15px] font-bold px-4 py-4 rounded-full shadow-md active:scale-[0.98] transition-transform"
          >
            <Image
              src="/images/donate_icon_100.png"
              alt="Donate Icon"
