  ...
  return (
    <section id="donate" className="bg-navy py-16">
      <div className="px-5 max-w-6xl mx-auto">
        ...
        {/* DONATION METHODS (FULL + CLEAR, BUT ORGANISED) */}
        <div className="mt-10 border border-white/20 rounded-xl p-5 text-white/80">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-6 text-[13px]">
            {/* GCash (PRIMARY LOCAL) */}
            <div>
...
<div className="mt-10 border border-white/20 rounded-xl p-5 text-white/80">
  ...
  <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-[13px]">
    ...
    <div>
      <p className="text-white font-medium">Bank Transfer (International)</p>
