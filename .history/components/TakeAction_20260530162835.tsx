      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-white/70 text-lg leading-relaxed">
            Your support helps children access education, food, and care. Choose
            how you’d like to contribute below.
          </p>
        </div>
        ...
        {/* SECONDARY ACTIONS */}
        <div className="mt-10 flex flex-col md:flex-row justify-center gap-4 text-center">
          <a
            href="#volunteer"
          ...
          <a
            ...
            className="text-white/80 hover:text-white underline underline-offset-4"
          >
            Partner or organize activities
          </a>
