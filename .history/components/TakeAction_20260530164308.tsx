export default function TakeAction() {
  ...
  <p className="text-white/60 text-center mt-2 text-sm max-w-2xl mx-auto">
    We accept multiple payment methods for your convenience. All contributions
    go directly to education, nutrition, and care programs.
  </p>

  <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 text-white/80 text-sm">

    <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
      <p className="font-semibold text-white">Bank Transfer</p>
      <p className="mt-2">Account Name: [YOUR NAME / FOUNDATION NAME]</p>
    ...
    <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
      ...
      <p className="mt-2">[paypal@email.com]</p>
    </div>

    <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
      <p className="font-semibold text-white">Venmo / Zelle</p>
      <p className="mt-2">Venmo: [@username]</p>
