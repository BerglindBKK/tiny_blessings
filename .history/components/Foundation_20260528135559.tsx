...
export default function Foundation() {
  return (
    <section id="foundation" className="bg-white py-16 md:py-24">
      <div className="px-5 max-w-6xl mx-auto lg:px-8 border-amber-400 border-2">
        {/* HEADER */}
        <p className="text-[11px] tracking-widest uppercase text-muted mb-3">
          About
        </p>
        {/* TOP SECTION */}
        <div className=" border-amber-600 border-2 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center lg:items-start ">
          {/* IMAGE */}
          <div className="border-amber-700 border-2 order-1 lg:order-2 lg:mt-16">
            <div className="relative border-amber-800 border-2 w-full aspect-[4/5] sm:aspect-square md:aspect-video lg:aspect-[4/3] rounded-2xl overflow-hidden shadow-sm">
              <Image
          ...
          <div
            border-amber-900
            border-2
            className="order-2 lg:order-1 max-w-3xl flex flex-col"
          >
