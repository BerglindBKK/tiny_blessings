  ...
  return (
    <section className="bg-white py-14">
      <div className="px-5 max-w-6xl mx-auto">
        ...
        {/* BUTTON */}
        <div className="mt-8">
          <div className="bg-soft border border-border rounded-xl p-5 flex items-center justify-between hover:shadow-sm transition">
            <div>
            ...
            <a
              ...
              target="_blank"
              className="bg-navy text-white text-[13px] font-semibold px-5 py-2 rounded-full whitespace-nowrap"
            >
              View Instagram
            </a>
          </div>
